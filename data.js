...
const CONFIG = {
  ...
  items: [
    ...
    { short:"CLARITY", name:"CLARITY 법안 통과확률", cat:"매크로·규제", weight:10, lo:-100, hi:100, raw:0, unit:"", live:"실시간", range:"pm100", value:"수집 대기…", desc:"미국 시장구조법(CLARITY Act) ‘2026년 내 서명’ 확률(Polymarket YES가). 하원 통과(2025.7)했으나 상원 클로처 표결 9/15 부결(49-50, 60표 미달) — 연내 서명은 사실상 무산 국면이라 확률이 매우 낮다. 높을수록 규제 명확성↑=코인 우호. 50%=중립(0)·90%=+80·100%=+100·0%=−100. 3시간마다 수집." },
    { short:"10월 FOMC", name:"10월 FOMC 금리", cat:"매크로·규제", weight:10, lo:-100, hi:100, raw:0, unit:"", live:"추정", pending:true, range:"pm100", value:"29일 새벽3시", desc:"10/27-28 FOMC 금리결정(발표 10/28 14:00 ET = 한국 10/29 새벽 3시). 인상(매파)=−100 / 인하(비둘기)=+100 / 미정=0. 결정 나면 갱신." },
