...
const CONFIG = {
  ...
  items: [
    ...
    { short:"스테이블 공급", name:"스테이블코인 공급량", cat:"기관·자금", weight:6, lo:-2, hi:6, raw:1, unit:"%/4wk", live:"실시간", range:"z100", value:"≈ $298B (추정 +1%/4wk)", desc:"USD 스테이블코인 전체(USDT·USDC·DAI 등) 시총. 늘면 대기 매수자금(마른 장작) 증가." },
    ...
    { short:"CLARITY", name:"CLARITY 법안 통과확률", cat:"매크로·규제", weight:10, lo:-100, hi:100, raw:0, unit:"", live:"실시간", range:"pm100", value:"수집 대기…", desc:"미국 시장구조법(CLARITY Act) ‘2026년 내 서명’ 확률(Polymarket YES가). 하원 통과(2025.7)·상원 표결 9/15 예정 — 통과해도 연내 서명은 불확실해 확률이 낮게 잡힌다(‘상원 통과’보다 빡센 기준). 높을수록 규제 명확성↑=코인 우호. 50%=중립(0)·90%=+80·100%=+100·0%=−100. 3시간마다 수집." },
    { short:"9월 FOMC", name:"9월 FOMC 금리", cat:"매크로·규제", weight:10, lo:-100, hi:100, raw:0, unit:"", live:"추정", pending:true, range:"pm100", value:"17일 새벽3시", desc:"9/15-16 FOMC 금리결정(발표 9/16 14:00 ET = 한국 9/17 새벽 3시). 인상(매파)=−100 / 인하(비둘기)=+100 / 미정=0. 결정 나면 갱신." },
