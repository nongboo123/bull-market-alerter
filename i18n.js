...
const ITEMS_EN = {
  ...
  'CLARITY': { short: 'CLARITY', name: 'CLARITY Act Odds', desc: "Odds the CLARITY Act (US market-structure law) is signed into law within 2026 (Polymarket YES). Passed the House (Jul 2025); Senate vote set for Sep 15 — even if it passes, 2026 signing stays uncertain, so odds sit low (a stricter bar than mere Senate passage). Higher = more regulatory clarity = coin-friendly. 50%=neutral, 100%=+100, 0%=−100." },
  '9월 FOMC': { short: 'Sep FOMC', name: 'Sep FOMC Rate', desc: 'Sep 15-16 FOMC rate decision (announced Sep 16, 2pm ET = Sep 17, 3am KST). Hike(hawkish)=−100, cut(dovish)=+100, undecided=0.', value: 'Sep 17, 3am KST' },
...
const VAL_TOKENS = [
  ...
  ['통과확률', 'Pass prob'], ['상원 9/15 표결', 'Senate vote Sep 15'],
