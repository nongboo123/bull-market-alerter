...
const I18N = {
  ko: {
    title: '지금 불장이야?', subtitle: '지표 30여 개로 재는 실시간 불장 온도',
    trendTitle: '총점 추이', neutral500: '500=중립',
    trendEmpty: '📈 오늘부터 총점 기록 시작 — 며칠 쌓이면 추이가 그려져요',
    live: '실시간', est: '추정', tmp: '임시', updated: '갱신(자동)', asof: '기준', srv: '서버수집',
    excluded: '총점 미반영 (미정)', whyBtc: 'BTC와의 관계', nowImpact: '지금 BTC 영향',
    deltaVs: '전일 아침 7시 대비',
    footContact: '문의',
  },
  en: {
    title: 'Is it a bull market?', subtitle: 'Live bull-market temperature from 30+ signals',
    trendTitle: 'Score trend', neutral500: '500 = neutral',
    trendEmpty: '📈 Recording started today — the trend line appears in a few days',
    live: 'live', est: 'est.', tmp: 'tmp', updated: 'auto-updated', asof: 'as of', srv: 'server',
...
const ITEMS_EN = {
  ...
  '스테이블 공급': { short: 'Stables', name: 'Stablecoin Supply', desc: 'Total USD stablecoin market cap (USDT, USDC, DAI…). Growth = dry powder (buyers waiting).' },
  ...
  'CLARITY': { short: 'CLARITY', name: 'CLARITY Act Odds', desc: "Odds the CLARITY Act (US market-structure law) is signed into law within 2026 (Polymarket YES). Passed the House (Jul 2025), but the Senate cloture vote failed 49–50 on Sep 15 (short of the 60 needed) — 2026 signing now looks effectively dead, so odds are very low. Higher = more regulatory clarity = coin-friendly. 50%=neutral, 100%=+100, 0%=−100." },
  '10월 FOMC': { short: 'Oct FOMC', name: 'Oct FOMC Rate', desc: 'Oct 27-28 FOMC rate decision (announced Oct 28, 2pm ET = Oct 29, 3am KST). Hike(hawkish)=−100, cut(dovish)=+100, undecided=0.', value: 'Oct 29, 3am KST' },
...
const VAL_TOKENS = [
  ...
  ['통과확률', 'Pass prob'], ['상원 9/15 부결(49-50)', 'Senate blocked it Sep 15 (49-50)'],
